                ...
                {Array.from({ length: ROW_SLOTS[row] }, (_, i) => {
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      background: unit ? 'rgba(192,112,112,0.08)' : 'rgba(0,0,0,0.02)',
                      border: `1.5px solid ${unit ? '#c0707044' : 'rgba(0,0,0,0.08)'}`,
              ...
              <div key={row} style={{ marginBottom: 6 }}>
                ...
                <div style={{ display: 'flex', gap: 5, justifyContent: 'center' }}>
                  {Array.from({ length: ROW_SLOTS[row] }, (_, i) => {
                    ...
                    const isTargetSlot = selected != null && !unit
                    ...
                    return (
                      <div
                        ...
                        style={{
                          width: 68, height: 72, borderRadius: 8, flexShrink: 0, cursor: 'pointer',
