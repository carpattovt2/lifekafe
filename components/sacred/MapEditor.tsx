...
const MOUNTAIN_SVGS = [
  ...
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 65"><g stroke="#4a3218" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M40,4 L8,61 L72,61 Z" fill="rgba(212,198,155,0.93)" stroke-width="1.4"/><path d="M40,4 L27,24 C34,21 46,21 53,24 Z" fill="rgba(242,238,226,0.96)" stroke-width="1"/><line x1="45" y1="13" x2="55" y2="30" stroke-width="0.7" opacity="0.55"/><line x1="48" y1="20" x2="60" y2="38" stroke-width="0.7" opacity="0.5"/><line x1="51" y1="27" x2="64" y2="46" stroke-width="0.65" opacity="0.45"/><line x1="54" y1="34" x2="67" y2="53" stroke-width="0.6" opacity="0.4"/></g></svg>`,
  // 2. double peak — grey granite
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95 65"><g stroke="#303038" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M62,12 L40,62 L84,62 Z" fill="rgba(180,185,192,0.84)" stroke-width="1.1" opacity="0.8"/><path d="M28,5 L2,62 L56,62 Z" fill="rgba(185,188,198,0.92)" stroke-width="1.4"/><path d="M28,5 L18,22 C24,19 32,19 38,22 Z" fill="rgba(238,240,248,0.96)" stroke-width="0.9"/><path d="M62,12 L55,25 C59,23 65,23 69,25 Z" fill="rgba(238,240,248,0.88)" stroke-width="0.8" opacity="0.85"/><line x1="31" y1="13" x2="41" y2="28" stroke-width="0.7" opacity="0.5"/><line x1="34" y1="20" x2="46" y2="36" stroke-width="0.65" opacity="0.45"/><line x1="37" y1="27" x2="50" y2="44" stroke-width="0.6" opacity="0.4"/></g></svg>`,
  // 3. mountain range 3 peaks — warm brown
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115 65"><g stroke="#4a3a18" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M20,20 L2,62 L40,62 Z" fill="rgba(205,185,148,0.84)" stroke-width="1" opacity="0.75"/><path d="M57,4 L27,62 L87,62 Z" fill="rgba(218,198,158,0.92)" stroke-width="1.4"/><path d="M92,16 L72,62 L112,62 Z" fill="rgba(205,185,148,0.82)" stroke-width="1" opacity="0.75"/><path d="M57,4 L46,21 C52,18 62,18 68,21 Z" fill="rgba(242,238,226,0.96)" stroke-width="1"/><path d="M20,20 L14,31 C17,29 23,29 26,31 Z" fill="rgba(242,238,226,0.88)" stroke-width="0.8" opacity="0.8"/><line x1="60" y1="12" x2="70" y2="27" stroke-width="0.7" opacity="0.5"/><line x1="63" y1="19" x2="74" y2="35" stroke-width="0.65" opacity="0.45"/><line x1="66" y1="26" x2="78" y2="43" stroke-width="0.6" opacity="0.4"/><line x1="68" y1="33" x2="80" y2="50" stroke-width="0.55" opacity="0.35"/></g></svg>`,
  // 4. rounded volcanic hill — ochre
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 60"><g stroke="#403218" stroke-linecap="round" fill="none"><path d="M40,7 Q18,7 7,56 L73,56 Q62,7 40,7 Z" fill="rgba(218,205,158,0.92)" stroke-width="1.4" stroke-linejoin="round"/><path d="M23,30 Q40,20 57,30" stroke-width="0.85" opacity="0.4"/><path d="M15,44 Q40,30 65,44" stroke-width="0.75" opacity="0.32"/><path d="M10,54 Q40,40 70,54" stroke-width="0.65" opacity="0.25"/><path d="M36,9 Q40,7 44,9" stroke-width="0.8" opacity="0.4"/></g></svg>`,
  // 5. mesa / flat-top plateau — blue-grey
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 63"><g stroke="#303840" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M8,61 L18,34 L30,21 L60,21 L72,34 L82,61 Z" fill="rgba(178,188,200,0.92)" stroke-width="1.4"/><path d="M30,21 L45,15 L60,21" fill="rgba(238,242,250,0.96)" stroke-width="0.9"/><line x1="18" y1="38" x2="10" y2="59" stroke-width="0.75" opacity="0.44"/><line x1="22" y1="37" x2="14" y2="59" stroke-width="0.6" opacity="0.35"/><line x1="72" y1="38" x2="80" y2="59" stroke-width="0.75" opacity="0.44"/><line x1="68" y1="37" x2="76" y2="59" stroke-width="0.6" opacity="0.35"/><line x1="32" y1="23" x2="30" y2="59" stroke-width="0.5" opacity="0.28"/><line x1="58" y1="23" x2="60" y2="59" stroke-width="0.5" opacity="0.28"/></g></svg>`,
  // 6. steep narrow cliff — red sandstone
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 68"><g stroke="#5a2a10" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M35,3 L18,65 L52,65 Z" fill="rgba(215,178,138,0.92)" stroke-width="1.5"/><path d="M35,3 L26,18 C29,15 41,15 44,18 Z" fill="rgba(246,240,228,0.96)" stroke-width="1"/><line x1="41" y1="11" x2="50" y2="30" stroke-width="0.8" opacity="0.5"/><line x1="44" y1="18" x2="54" y2="38" stroke-width="0.7" opacity="0.45"/><line x1="46" y1="25" x2="56" y2="46" stroke-width="0.65" opacity="0.4"/><line x1="47" y1="33" x2="57" y2="54" stroke-width="0.6" opacity="0.35"/></g></svg>`,
  // 7. twin peaks — ivory
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 65"><g stroke="#3a2a10" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M30,5 L5,62 L55,62 Z" fill="rgba(210,196,158,0.92)" stroke-width="1.4"/><path d="M60,9 L38,62 L82,62 Z" fill="rgba(198,188,150,0.84)" stroke-width="1.2"/><path d="M30,5 L20,22 C25,19 35,19 39,22 Z" fill="rgba(242,238,226,0.96)" stroke-width="0.9"/><path d="M60,9 L52,24 C56,22 64,22 68,24 Z" fill="rgba(242,238,226,0.90)" stroke-width="0.9"/><path d="M39,22 Q48,30 52,24" stroke-width="0.8" fill="rgba(242,238,226,0.75)"/><line x1="34" y1="13" x2="44" y2="29" stroke-width="0.7" opacity="0.48"/><line x1="37" y1="20" x2="49" y2="37" stroke-width="0.65" opacity="0.42"/></g></svg>`,
  // 8. broad ridged mountain — olive-grey
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 62"><g stroke="#3a3818" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M55,6 L5,60 L105,60 Z" fill="rgba(195,198,165,0.92)" stroke-width="1.4"/><path d="M55,6 L43,23 C49,20 61,20 67,23 Z" fill="rgba(240,240,228,0.96)" stroke-width="1"/><path d="M16,42 Q55,30 94,42" stroke-width="0.85" opacity="0.35" fill="none"/><path d="M10,52 Q55,38 100,52" stroke-width="0.7" opacity="0.28" fill="none"/><line x1="59" y1="14" x2="70" y2="31" stroke-width="0.7" opacity="0.5"/><line x1="63" y1="21" x2="76" y2="39" stroke-width="0.65" opacity="0.42"/><line x1="67" y1="29" x2="80" y2="47" stroke-width="0.6" opacity="0.36"/></g></svg>`,
  // 9. narrow spire — dark basalt
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 72"><g stroke="#2a2010" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M29,2 L11,68 L47,68 Z" fill="rgba(162,152,132,0.92)" stroke-width="1.4"/><path d="M29,2 L23,15 C25,13 33,13 35,15 Z" fill="rgba(242,238,226,0.96)" stroke-width="0.9"/><line x1="32" y1="8" x2="40" y2="24" stroke-width="0.8" opacity="0.54"/><line x1="34" y1="16" x2="42" y2="33" stroke-width="0.72" opacity="0.47"/><line x1="36" y1="23" x2="44" y2="41" stroke-width="0.65" opacity="0.41"/><line x1="37" y1="31" x2="44" y2="49" stroke-width="0.6" opacity="0.35"/><line x1="38" y1="39" x2="44" y2="57" stroke-width="0.55" opacity="0.3"/></g></svg>`,
  // 10. four-peak panoramic range — sandy
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 65"><g stroke="#3a2a10" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M12,18 L2,62 L24,62 Z" fill="rgba(195,182,142,0.82)" stroke-width="0.9" opacity="0.75"/><path d="M38,6 L15,62 L61,62 Z" fill="rgba(218,198,158,0.92)" stroke-width="1.3"/><path d="M82,9 L56,62 L108,62 Z" fill="rgba(212,195,155,0.90)" stroke-width="1.2"/><path d="M116,20 L104,62 L128,62 Z" fill="rgba(195,182,142,0.82)" stroke-width="0.9" opacity="0.75"/><path d="M38,6 L29,21 C33,18 43,18 47,21 Z" fill="rgba(242,238,226,0.96)" stroke-width="0.9"/><path d="M82,9 L73,23 C77,21 87,21 91,23 Z" fill="rgba(242,238,226,0.92)" stroke-width="0.9"/><line x1="41" y1="14" x2="51" y2="30" stroke-width="0.7" opacity="0.48"/><line x1="44" y1="22" x2="55" y2="38" stroke-width="0.65" opacity="0.42"/><line x1="85" y1="17" x2="93" y2="31" stroke-width="0.65" opacity="0.45"/><line x1="87" y1="24" x2="96" y2="39" stroke-width="0.6" opacity="0.38"/></g></svg>`,
]

const FOREST_SVGS = [
  // 1. single deciduous — classic green
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 72"><g stroke="#1e3812" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="30" y1="48" x2="30" y2="68" stroke-width="2.8"/><line x1="30" y1="62" x2="20" y2="70" stroke-width="1.6"/><line x1="30" y1="62" x2="40" y2="70" stroke-width="1.6"/><path d="M30,5 C12,5 5,17 5,27 C5,41 15,50 30,50 C45,50 55,41 55,27 C55,17 48,5 30,5 Z" fill="rgba(65,95,32,0.90)" stroke-width="1.4"/><line x1="30" y1="50" x2="30" y2="32" stroke-width="0.85" opacity="0.45"/><line x1="30" y1="39" x2="17" y2="28" stroke-width="0.8" opacity="0.4"/><line x1="30" y1="39" x2="43" y2="28" stroke-width="0.8" opacity="0.4"/><line x1="30" y1="31" x2="21" y2="20" stroke-width="0.7" opacity="0.35"/><line x1="30" y1="31" x2="39" y2="20" stroke-width="0.7" opacity="0.35"/></g></svg>`,
  // 2. pine / conifer — deep pine
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 75"><g stroke="#0e2818" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="30" y1="60" x2="30" y2="73" stroke-width="2.8"/><path d="M30,5 L12,36 L48,36 Z" fill="rgba(28,65,35,0.92)" stroke-width="1.3"/><path d="M30,24 L10,52 L50,52 Z" fill="rgba(28,65,35,0.92)" stroke-width="1.3"/><path d="M30,41 L14,63 L46,63 Z" fill="rgba(28,65,35,0.92)" stroke-width="1.3"/></g></svg>`,
  // 3. two trees — medium green
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 85 72"><g stroke="#1e3518" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="22" y1="44" x2="22" y2="65" stroke-width="2.2"/><path d="M22,9 C11,9 5,18 5,26 C5,37 12,45 22,45 C32,45 39,37 39,26 C39,18 33,9 22,9 Z" fill="rgba(55,85,32,0.90)" stroke-width="1.2"/><line x1="22" y1="45" x2="22" y2="30" stroke-width="0.75" opacity="0.4"/><line x1="22" y1="37" x2="13" y2="27" stroke-width="0.7" opacity="0.35"/><line x1="22" y1="37" x2="31" y2="27" stroke-width="0.7" opacity="0.35"/><line x1="62" y1="49" x2="62" y2="70" stroke-width="2.8"/><path d="M62,5 C47,5 40,16 40,27 C40,41 49,51 62,51 C75,51 84,41 84,27 C84,16 77,5 62,5 Z" fill="rgba(55,85,32,0.90)" stroke-width="1.4"/><line x1="62" y1="51" x2="62" y2="33" stroke-width="0.85" opacity="0.45"/><line x1="62" y1="40" x2="49" y2="29" stroke-width="0.8" opacity="0.4"/><line x1="62" y1="40" x2="75" y2="29" stroke-width="0.8" opacity="0.4"/><line x1="62" y1="32" x2="54" y2="22" stroke-width="0.7" opacity="0.35"/><line x1="62" y1="32" x2="70" y2="22" stroke-width="0.7" opacity="0.35"/></g></svg>`,
  // 4. mixed cluster — deep forest
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95 72"><g stroke="#1a3210" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="48" y1="52" x2="48" y2="64" stroke-width="2.2" opacity="0.7"/><path d="M48,8 L34,35 L62,35 Z" fill="rgba(35,68,28,0.90)" stroke-width="1.1" opacity="0.85"/><path d="M48,28 L32,54 L64,54 Z" fill="rgba(35,68,28,0.90)" stroke-width="1.1" opacity="0.85"/><line x1="18" y1="46" x2="18" y2="66" stroke-width="2.4"/><path d="M18,10 C7,10 1,20 1,28 C1,40 8,47 18,47 C28,47 35,40 35,28 C35,20 29,10 18,10 Z" fill="rgba(45,72,22,0.90)" stroke-width="1.3"/><line x1="18" y1="47" x2="18" y2="31" stroke-width="0.8" opacity="0.4"/><line x1="18" y1="38" x2="9" y2="28" stroke-width="0.72" opacity="0.35"/><line x1="18" y1="38" x2="27" y2="28" stroke-width="0.72" opacity="0.35"/><line x1="76" y1="46" x2="76" y2="66" stroke-width="2.4"/><path d="M76,12 C65,12 59,21 59,29 C59,40 66,47 76,47 C86,47 93,40 93,29 C93,21 87,12 76,12 Z" fill="rgba(45,72,22,0.90)" stroke-width="1.3"/><line x1="76" y1="47" x2="76" y2="31" stroke-width="0.8" opacity="0.4"/><line x1="76" y1="38" x2="67" y2="28" stroke-width="0.72" opacity="0.35"/><line x1="76" y1="38" x2="85" y2="28" stroke-width="0.72" opacity="0.35"/></g></svg>`,
  // 5. row of 3 pines — dark pine
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 72"><g stroke="#0c2015" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="16" y1="58" x2="16" y2="70" stroke-width="2.2"/><path d="M16,12 L5,36 L27,36 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.1"/><path d="M16,30 L5,50 L27,50 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.1"/><line x1="48" y1="54" x2="48" y2="70" stroke-width="2.6"/><path d="M48,7 L33,34 L63,34 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.3"/><path d="M48,26 L32,52 L64,52 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.3"/><path d="M48,43 L37,62 L59,62 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.2"/><line x1="80" y1="58" x2="80" y2="70" stroke-width="2.2"/><path d="M80,14 L69,37 L91,37 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.1"/><path d="M80,32 L69,54 L91,54 Z" fill="rgba(25,55,32,0.92)" stroke-width="1.1"/></g></svg>`,
  // 6. ancient oak wide canopy — rich green
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86 72"><g stroke="#182e0e" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="43" y1="44" x2="43" y2="68" stroke-width="4"/><line x1="43" y1="60" x2="25" y2="70" stroke-width="2.2"/><line x1="43" y1="60" x2="61" y2="70" stroke-width="2.2"/><path d="M43,5 C18,5 6,18 6,30 C6,46 22,52 43,52 C64,52 80,46 80,30 C80,18 68,5 43,5 Z" fill="rgba(48,78,25,0.92)" stroke-width="1.6"/><line x1="43" y1="52" x2="43" y2="28" stroke-width="0.9" opacity="0.45"/><line x1="43" y1="37" x2="24" y2="22" stroke-width="0.85" opacity="0.4"/><line x1="43" y1="37" x2="62" y2="22" stroke-width="0.85" opacity="0.4"/><line x1="43" y1="26" x2="30" y2="14" stroke-width="0.7" opacity="0.33"/><line x1="43" y1="26" x2="56" y2="14" stroke-width="0.7" opacity="0.33"/><line x1="24" y1="22" x2="14" y2="14" stroke-width="0.65" opacity="0.28"/><line x1="62" y1="22" x2="72" y2="14" stroke-width="0.65" opacity="0.28"/></g></svg>`,
  // 7. three deciduous varying heights — medium
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 72"><g stroke="#1e3812" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="18" y1="50" x2="18" y2="70" stroke-width="2"/><path d="M18,13 C8,13 2,22 2,30 C2,42 9,51 18,51 C27,51 34,42 34,30 C34,22 28,13 18,13 Z" fill="rgba(58,90,30,0.88)" stroke-width="1.2"/><line x1="18" y1="51" x2="18" y2="34" stroke-width="0.75" opacity="0.4"/><line x1="18" y1="41" x2="9" y2="31" stroke-width="0.7" opacity="0.35"/><line x1="18" y1="41" x2="27" y2="31" stroke-width="0.7" opacity="0.35"/><line x1="48" y1="44" x2="48" y2="68" stroke-width="2.8"/><path d="M48,5 C30,5 22,17 22,27 C22,41 32,51 48,51 C64,51 74,41 74,27 C74,17 66,5 48,5 Z" fill="rgba(58,90,30,0.88)" stroke-width="1.4"/><line x1="48" y1="51" x2="48" y2="30" stroke-width="0.85" opacity="0.43"/><line x1="48" y1="39" x2="34" y2="26" stroke-width="0.8" opacity="0.38"/><line x1="48" y1="39" x2="62" y2="26" stroke-width="0.8" opacity="0.38"/><line x1="48" y1="28" x2="38" y2="17" stroke-width="0.7" opacity="0.33"/><line x1="48" y1="28" x2="58" y2="17" stroke-width="0.7" opacity="0.33"/><line x1="78" y1="52" x2="78" y2="70" stroke-width="2.2"/><path d="M78,18 C68,18 62,27 62,34 C62,45 69,53 78,53 C87,53 94,45 94,34 C94,27 88,18 78,18 Z" fill="rgba(58,90,30,0.88)" stroke-width="1.2"/><line x1="78" y1="53" x2="78" y2="38" stroke-width="0.75" opacity="0.4"/><line x1="78" y1="44" x2="69" y2="35" stroke-width="0.7" opacity="0.35"/><line x1="78" y1="44" x2="87" y2="35" stroke-width="0.7" opacity="0.35"/></g></svg>`,
  // 8. weeping tree — sage green
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 75"><g stroke="#1a2e15" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="35" y1="30" x2="35" y2="70" stroke-width="3"/><line x1="35" y1="60" x2="20" y2="72" stroke-width="1.8"/><line x1="35" y1="60" x2="50" y2="72" stroke-width="1.8"/><path d="M35,5 C20,5 14,16 14,24 C14,32 20,36 35,36 C50,36 56,32 56,24 C56,16 50,5 35,5 Z" fill="rgba(52,78,38,0.90)" stroke-width="1.3"/><path d="M14,24 C10,30 8,40 13,50" stroke-width="0.9" opacity="0.35"/><path d="M56,24 C60,30 62,40 57,50" stroke-width="0.9" opacity="0.35"/><path d="M24,36 C18,44 17,54 22,62" stroke-width="0.8" opacity="0.3"/><path d="M46,36 C52,44 53,54 48,62" stroke-width="0.8" opacity="0.3"/><path d="M35,36 C33,46 32,57 35,66" stroke-width="0.75" opacity="0.28"/></g></svg>`,
  // 9. sapling cluster — spring green
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 85 65"><g stroke="#2a4818" stroke-linecap="round" stroke-linejoin="round" fill="none"><line x1="12" y1="44" x2="12" y2="60" stroke-width="1.6"/><path d="M12,18 C6,18 2,25 2,30 C2,38 6,44 12,44 C18,44 22,38 22,30 C22,25 18,18 12,18 Z" fill="rgba(72,105,40,0.88)" stroke-width="1"/><line x1="32" y1="38" x2="32" y2="58" stroke-width="1.8"/><path d="M32,10 C24,10 18,19 18,26 C18,35 24,39 32,39 C40,39 46,35 46,26 C46,19 40,10 32,10 Z" fill="rgba(72,105,40,0.88)" stroke-width="1.1"/><line x1="32" y1="39" x2="32" y2="25" stroke-width="0.7" opacity="0.38"/><line x1="55" y1="42" x2="55" y2="60" stroke-width="1.6"/><path d="M55,16 C47,16 42,24 42,30 C42,38 47,43 55,43 C63,43 68,38 68,30 C68,24 63,16 55,16 Z" fill="rgba(72,105,40,0.88)" stroke-width="1"/><line x1="73" y1="50" x2="73" y2="62" stroke-width="1.4"/><path d="M73,30 C67,30 63,36 63,41 C63,48 67,51 73,51 C79,51 83,48 83,41 C83,36 79,30 73,30 Z" fill="rgba(65,95,35,0.85)" stroke-width="0.9"/></g></svg>`,
  // 10. dense bush / thicket — dark
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 60"><g stroke="#152210" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M14,55 C4,55 1,46 5,40 C2,34 6,28 13,28 C13,20 19,15 26,18 C29,10 39,10 41,18 C47,12 57,15 57,24 C63,20 70,25 70,32 C76,30 83,36 80,44 C84,51 78,57 71,55 Z" fill="rgba(38,62,22,0.92)" stroke-width="1.4"/><path d="M9,42 C8,36 12,32 16,34" stroke-width="0.8" opacity="0.35"/><path d="M25,20 C27,15 33,15 35,20" stroke-width="0.8" opacity="0.32"/><path d="M51,16 C55,13 61,15 60,21" stroke-width="0.8" opacity="0.32"/><path d="M66,27 C70,23 76,26 74,31" stroke-width="0.8" opacity="0.32"/><path d="M28,55 Q42,46 57,55" stroke-width="0.7" opacity="0.25"/></g></svg>`,
]
...
function genMtnSVG(seed: number): string {
  ...
  const MTN_PALS: [string,string,string,string][] = [
    ['rgba(212,198,155,0.92)','rgba(195,182,142,0.82)','rgba(242,238,226,0.96)','#4a3218'],
    ['rgba(185,188,198,0.92)','rgba(172,175,185,0.82)','rgba(238,240,248,0.96)','#303038'],
    ['rgba(215,178,138,0.92)','rgba(200,165,125,0.82)','rgba(246,240,228,0.96)','#5a2a10'],
    ['rgba(178,188,200,0.92)','rgba(165,175,188,0.82)','rgba(238,242,250,0.96)','#303840'],
    ['rgba(162,152,132,0.92)','rgba(148,140,122,0.82)','rgba(238,235,225,0.96)','#2a2010'],
    ['rgba(218,205,158,0.92)','rgba(202,188,142,0.82)','rgba(242,238,226,0.96)','#403218'],
    ['rgba(195,198,165,0.92)','rgba(180,183,150,0.82)','rgba(240,240,228,0.96)','#3a3818'],
  ]
  ...
  pks.forEach(([cx, ty, bL, bR], idx) => {
    ...
    o += `<path d="M${cx},${ty} L${bL},${bY} L${bR},${bY} Z" fill="${m?mF:bF}" stroke-width="${m?'1.4':'1.0'}"${m?'':' opacity="0.78"'}/>`
    const hw = Math.min(bR - cx, cx - bL) * 0.3
    const sB = (ty + hw * 1.5).toFixed(1)
    o += `<path d="M${cx},${ty} L${(cx-hw).toFixed(1)},${sB} C${(cx-hw*.5).toFixed(1)},${(ty+hw).toFixed(1)} ${(cx+hw*.5).toFixed(1)},${(ty+hw).toFixed(1)} ${(cx+hw).toFixed(1)},${sB} Z" fill="${sF}" stroke-width="${m?'0.9':'0.75'}"${m?'':' opacity="0.82"'}/>`
...
function genForestSVG(seed: number): string {
  ...
  const FST_PALS: [string,string][] = [
    ['rgba(65,95,32,0.90)','#1e3812'],
    ['rgba(28,65,35,0.92)','#0e2818'],
    ['rgba(55,85,32,0.90)','#1e3518'],
    ['rgba(45,72,22,0.90)','#1a3210'],
    ['rgba(72,105,40,0.88)','#2a4818'],
    ['rgba(38,62,22,0.92)','#152210'],
    ['rgba(52,78,38,0.90)','#1a2e15'],
    ['rgba(35,68,28,0.92)','#102010'],
  ]
